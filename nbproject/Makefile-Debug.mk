...
${OBJECTDIR}/_ext/1345361123/Chord.o: ../ChordGen/Chord.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1345361123/Chord.o ../ChordGen/Chord.cpp

${OBJECTDIR}/_ext/1345361123/ChordGen.o: ../ChordGen/ChordGen.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1345361123
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1345361123/ChordGen.o ../ChordGen/ChordGen.cpp

${OBJECTDIR}/_ext/1345361123/ChordSequence.o: ../ChordGen/ChordSequence.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1345361123
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1345361123/ChordSequence.o ../ChordGen/ChordSequence.cpp

${OBJECTDIR}/_ext/1345361123/Scale.o: ../ChordGen/Scale.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1345361123
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1345361123/Scale.o ../ChordGen/Scale.cpp

${OBJECTDIR}/_ext/1345361123/main.o: ../ChordGen/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1345361123
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1345361123/main.o ../ChordGen/main.cpp

${OBJECTDIR}/chord_gen.o: chord_gen.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. `cppunit-config --cflags`  -MMD -MP -MF $@.d -o ${OBJECTDIR}/chord_gen.o chord_gen.cpp
