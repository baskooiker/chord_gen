...
LIBRARY_NAME = chord_gen

# add your .c source files, one object per file, to the SOURCES
# variable, help files will be included automatically, and for GUI
# objects, the matching .tcl file too
SOURCES = chord_gen.cpp

# list all pd objects (i.e. myobject.pd) files here, and their helpfiles will
# be included automatically
PDOBJECTS = chord_gen.pd
...
ALL_CFLAGS = -I"$(PD_INCLUDE)" -I"../utils" -I"."
ALL_LDFLAGS =  
SHARED_LDFLAGS =
ALL_LIBS = 
...
./RhythmGenerator.o: ../ChordGen/RhythmGenerator.cpp
	$(CC) $(ALL_CFLAGS) -o "./RhythmGenerator.o" -c "../ChordGen/RhythmGenerator.cpp"
	
./ChordGenStrategy.o: ../ChordGen/ChordGenStrategy.cpp
	$(CC) $(ALL_CFLAGS) -o "./ChordGenStrategy.o" -c "../ChordGen/ChordGenStrategy.cpp"
		
./BackToFront.o: ../ChordGen/BackToFront.cpp
	$(CC) $(ALL_CFLAGS) -o "./BackToFront.o" -c "../ChordGen/BackToFront.cpp"
		
./FrontToBack.o: ../ChordGen/FrontToBack.cpp
	$(CC) $(ALL_CFLAGS) -o "./FrontToBack.o" -c "../ChordGen/FrontToBack.cpp"
		
./ChordSequence.o: ../ChordGen/ChordSequence.cpp
	$(CC) $(ALL_CFLAGS) -o "./ChordSequence.o" -c "../ChordGen/ChordSequence.cpp"
	
./Scale.o: ../ChordGen/Scale.cpp
	$(CC) $(ALL_CFLAGS) -o "./Scale.o" -c "../ChordGen/Scale.cpp"
	
./Chord.o: ../ChordGen/Chord.cpp
	$(CC) $(ALL_CFLAGS) -o "./Chord.o" -c "../ChordGen/Chord.cpp"
	
./ChordGen.o: ../ChordGen/ChordGen.cpp
	$(CC) $(ALL_CFLAGS) -o "./ChordGen.o" -c "../ChordGen/ChordGen.cpp"

%.o: %.c
	$(CC) $(ALL_CFLAGS) -o "$*.o" -c "$*.c"

%.$(EXTENSION): %.o RhythmGenerator.o ChordGenStrategy.o BackToFront.o FrontToBack.o ChordSequence.o ./Chord.o  ./ChordGen.o ./Scale.o $(SHARED_LIB)
	$(CC) $(ALL_LDFLAGS) -o "$*.$(EXTENSION)" "$*.o" "./Chord.o" "./ChordSequence.o" "./Scale.o" "./ChordGen.o" "RhythmGenerator.o" "ChordGenStrategy.o" "./FrontToBack.o" "./BackToFront.o" $(ALL_LIBS) $(SHARED_LIB)
	rm ./ChordGen.o
	rm ./Scale.o
	rm ./Chord.o
	rm ./ChordSequence.o
	rm ./FrontToBack.o
	rm ./BackToFront.o
	rm ChordGenStrategy.o
	rm RhythmGenerator.o
	chmod a-x "$*.$(EXTENSION)"
...
clean:
	...
	-rm -f .Scale.o
	-rm -f .Chord.o
	-rm -f -- $(SOURCES:.cpp=.o) $(SOURCES_LIB:.c=.o) $(SHARED_SOURCE:.c=.o)
